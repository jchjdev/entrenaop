-- Amplía el creador personal para guardar varios bloques convencionales.
-- La función sigue siendo atómica: una validación fallida revierte la sesión
-- completa y nunca deja plantillas parcialmente construidas.
...
begin
  ...
  loop
    ...
    if block_format <> 'straight_sets' then
      raise exception 'This creator only supports straight set blocks';
    end if;
    ...
    total_exercises := total_exercises
      + jsonb_array_length(block_json -> 'exercises');
